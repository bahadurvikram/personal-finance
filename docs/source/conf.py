...
# savings_prediction documentation build
...
from savings_prediction import __version__ as release

# -- Project information -----------------------------------------------------

project = "savings_prediction"
author = "Kedro"
...
htmlhelp_basename = "savings_predictiondoc"
...
latex_documents = [
    (
        master_doc,
        "savings_prediction.tex",
        "savings_prediction Documentation",
        "Kedro",
        "manual",
    )
]
...
texinfo_documents = [
    (
        ...
        author,
        "savings_prediction",
        "Project savings_prediction codebase.",
        "Data-Science",
    )
]
